...
coormatrix_features = data2.loc[:, ('accommodates','bathrooms', 'bedrooms', 'security_deposit', 
                                 'cleaning_fee', 'guests_included','availability_365','property_type_Hotel','price' )]
...
print('#',50*"-")
print('R2 score / Variance score: %.2f' % r2_score(V_test, airbnb_V_pred))
print('#',50*"-")
...
print('#',50*"-")
print('R2 score / Variance score: %.2f' % r2_score(y_test, airbnb_y_pred))
print('#',50*"-")
...
print('Performance metrics for our kind of social science data with 0.41 R2 value and score 0.40 and MSE: 0.57 can be considered as good')
...
print('If we see the performence metrics from random Forest Regression and Linear Regression, then we can see that Linear model is performing better than tree based model.')
